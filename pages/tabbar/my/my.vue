<template>
	<view>
		...
		<view class="my-content">
			<view class="my-content__list" @click="open(1)">
			...
			<view class="my-content__list" @click="open(2)">
				<view class="my-content__list-title">
...
<style lang="scss">
	...
	.my-header{
		...
		.my-header__background{
			position: absolute; top: 0;right: 0;bottom: 0;left: 0;filter: blur(8px);opacity: 0.3;
		...
		.my-header__logo{
			...
			.my-header__name{ margin-top: 15px;font-size: 16px;font-weight: bold; }
		}
		.my-header__info{
			margin-top: 15px;display: flex;
			.my-header__info-box{
				display: flex;flex-direction: column;justify-content: center;align-items: center;width: 100%;font-size: 12px;color: #999;
				.my-header__info-title{ font-size: 14px;color: #333; }
			}
		}
	}
	.my-content{
		margin-top: 20px;
		.my-content__list{
			display: flex;justify-content: space-between;padding: 15px;margin-bottom: 10px;color: #333;background-color: #fff;font-size: 14px;
